...
refId=$(curl -s "http://172.25.159.27:9090/aqa-rest/ci/scan?token=DEMO-1234567890&pid=BookstoreApp&scan=BookstorePhase1&engine=aqa,fortify&fortify=true" | python -c 'import sys, json; print json.load(sys.stdin)["result"]')
